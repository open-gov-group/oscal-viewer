...
Phase 4a hat die Grundlagen gelegt: HrefParser (4 Patterns), LinkBadge (5 Farben), Fragment-Links. Phase 4b baut darauf auf und implementiert die **Profile Resolution Pipeline** — das Kernstück der OSCAL-Referenzkettenaufloesung.
